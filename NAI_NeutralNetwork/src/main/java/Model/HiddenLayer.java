...
public class HiddenLayer {
    ...
    public Matrix calOutLayerError(Matrix hiddenWeight, Matrix outError, Matrix inputOutr){
        this.hiddenLayerError = Matrix.backPropError(hiddenWeight, outError, inputOut);
